...
dotnet ef migrations add $migrations -c ApplicationSsoContext -o Migrations/SqlServer/Identity  -p ..\..\Backend\Jp.Database\Jp.Database.csproj

# MySql Migration
$settings = $settings -replace '"DatabaseType".*', '"DatabaseType": "MySql",'
$settings | set-content 'appsettings.json'

dotnet ef migrations add $migrations -c ApplicationSsoContext -o Migrations/MySql/Identity -p ..\..\Backend\Jp.Database\Jp.Database.csproj

# Postgre Migration
$settings = $settings -replace '"DatabaseType".*', '"DatabaseType": "Postgre",'
$settings | set-content 'appsettings.json'

dotnet ef migrations add $migrations -c ApplicationSsoContext -o Migrations/Postgre/Identity -p ..\..\Backend\Jp.Database\Jp.Database.csproj

# Sqlite Migration
$settings = $settings -replace '"DatabaseType".*', '"DatabaseType": "Sqlite",'
$settings | set-content 'appsettings.json'

dotnet ef migrations add $migrations -c ApplicationSsoContext -o Migrations/Sqlite/Identity -p ..\..\Backend\Jp.Database\Jp.Database.csproj
